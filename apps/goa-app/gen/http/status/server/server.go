...
import (
	...
	status "github.com/example/project-template/apps/goa-app/gen/status"
...
// MountShowHandler configures the mux to serve the "status" service "show"
// endpoint.
