...
// to call the "status" service "show" endpoint
func (c *Client) BuildShowRequest(ctx context.Context, v any) (*http.Request, error) {
	u := &url.URL{Scheme: c.scheme, Host: c.host, Path: ShowStatusPath()}
	req, err := http.NewRequest("GET", u.String(), nil)
	if err != nil {
		return nil, goahttp.ErrInvalidURL("status", "show", u.String(), err)
	}
	if ctx != nil {
...
// DecodeShowResponse returns a decoder for responses returned by the status
...
func DecodeShowResponse(decoder func(*http.Response) goahttp.Decoder, restoreBody bool) func(*http.Response) (any, error) {
	return func(resp *http.Response) (any, error) {
		...
		case http.StatusOK:
			...
			if err != nil {
				return nil, goahttp.ErrDecodingError("status", "show", err)
			}
			return body, nil
		default:
			body, _ := io.ReadAll(resp.Body)
			return nil, goahttp.ErrInvalidResponse("status", "show", resp.StatusCode, string(body))
		}
	}
}
